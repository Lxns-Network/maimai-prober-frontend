...
export const ChunithmCreateScoreModalContent = ({
  score,
  onSubmit,
  onClose,
  ...
  return (
    <form
      onSubmit={form.onSubmit((values) => {
        openConfirmModal(
          "确认创建成绩",
          "你确定要创建成绩吗？我们不推荐手动维护成绩，这可能会导致未来 Rating 与游戏内显示不一致。",
      ...
      <Grid mb="xs">
          ...
          <Input.Wrapper label="Full Combo" withAsterisk {...form.getInputProps("full_combo")}>
            <Chip.Group onChange={(value) => form.setValues({ full_combo: value as string })}>
              <Flex wrap="wrap" columnGap="md" rowGap="xs">
                <Chip size="xs" value="nofullcombo">
                  无
                </Chip>
                <Chip size="xs" value="fullcombo">
                  FC
                </Chip>
                <Chip size="xs" value="alljustice">
                  AJ
                </Chip>
                <Chip size="xs" value="alljusticecritical">
                  AJC
                </Chip>
              </Flex>
            </Chip.Group>
        ...
        <Grid.Col span={12}>
          <Input.Wrapper
            ...
            mb="md"
            withAsterisk
            {...form.getInputProps("full_chain")}
          >
            <Chip.Group onChange={(value) => form.setValues({ full_chain: value as string })}>
              <Flex wrap="wrap" columnGap="md" rowGap="xs">
                <Chip size="xs" value="nofullchain">
                  无
                </Chip>
                <Chip size="xs" value="fullchain">
                  铂
                </Chip>
                <Chip size="xs" value="fullchain2">
                  金
                </Chip>
              </Flex>
            </Chip.Group>
