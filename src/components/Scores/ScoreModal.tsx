      ...
      <Modal.Content ref={containerRef}>
        <Modal.Header mah={60}>
          <Modal.Title>
            <Transition
              ...
              duration={250}
            >
              {(styles) => <Text style={styles}>成绩详情</Text>}
            </Transition>
            <Transition
                  ...
                  <Stack gap={0}>
                    ...
                    {difficultyState && difficultyState.difficulty && (
                      <Text
                        size="sm"
                        fw="700"
                        c={getDifficultyColor(game, difficultyState.difficulty)}
                      >
        ...
        <Modal.Body p={0}>
          {songState && songState.song && (
            <Container ref={ref}>
              {songState.game === "maimai" && isMaimaiScoreProps(score) && (
          ...
          >
            ...
            {difficultyState && difficultyState.difficulty && (
              <Accordion.Item value="chart">
                ...
                <Accordion.Panel>
                  {difficultyState.game === "maimai" && isMaimaiScoreProps(score) && (
                    <MaimaiChart difficulty={difficultyState.difficulty} />
                  )}
                  {difficultyState.game === "chunithm" && isChunithmScoreProps(score) && (
                    <ChunithmChart difficulty={difficultyState.difficulty} />
                  )}
                </Accordion.Panel>
              </Accordion.Item>
            )}
